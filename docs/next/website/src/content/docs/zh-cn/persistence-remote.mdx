...
| 远程 Agent | 图片桥接方式 |
| --- | --- |
| Claude Code、Codex、Cursor CLI、Cline、OMP、MastraCode、OpenCode、GitHub Copilot CLI、Kiro、Factory Droid、Grok、Hermes、Kilo Code、Qoder CLI、Maki、ZCode | 远程暂存图片的绝对路径 |
| Pi、Amp | 暂存路径的 `@` 引用 |

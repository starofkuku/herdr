...
Windows Terminal 客户端（包括 WSL 配置文件）会为 `delivery = "terminal"` 使用 OSC 777。请先在 Windows Terminal 配置文件中启用 `compatibility.allowOSC777`；设置方法和安全说明请参阅 [Windows 测试版](/docs/windows-beta/#windows-terminal-通知)。
